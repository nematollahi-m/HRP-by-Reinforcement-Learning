...
class EnvironmentEnv(Env):
    def __init__(self):
        ...
        self.productivity_beg = np.random.normal(PRODUCTIVITY_BEG, 0.03448) * 1450
        self.productivity_int = np.random.normal(PRODUCTIVITY_INT, 0.0258) * 1450
        self.productivity_adv = np.random.normal(PRODUCTIVITY_ADV, 0.01724) * 1450
